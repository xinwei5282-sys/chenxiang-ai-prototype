...
function CurrentPagePrd({ pageKey }: { pageKey: ProductDocPageKey }) {
  ...
  const updatedAt = ["provenance", "home", "profile", "certificate-list", "certificate", "chip-help"].includes(resolvedPageKey) ? "2026-09-20" : ["home", "enterprise-custom", "incense-gift", "industrial-park", "provenance"].includes(resolvedPageKey) ? "2026-09-18" : resolvedPageKey === "certificate" || resolvedPageKey === "certificate-list" ? "2026-09-01" : "2026-08-31";
